...
public class CanvasManager : MonoBehaviour
{
    ...
    public TMP_Text manaText; // Add this line
    ...
    void Start()
    {
        ...
        if (healthText)
        {
            ...
            GameManager.Instance.OnHealthChanged += (health) => healthText.text = $"Health: {health}";
        }

        if (manaText)
        {
            manaText.text = $"Mana: {GameManager.Instance.mana}";
        }
